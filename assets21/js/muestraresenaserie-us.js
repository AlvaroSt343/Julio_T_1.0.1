...
const url55 = "https://api.themoviedb.org/3/tv/"+ valor +"/reviews?api_key=15c78749fb202cfe47bdd8f4989396e2";
    ...
    if(json.results.length > 0){
        ...
        `
            ...
            <div class="col-12">
                <div class="resena-contenido mb-3">
                    ...
                    <a class="verenlace" target="_blank" href="${resena.url}">See more...</a>
                </div>                
            </div>
        `
      )
      .join('') 
        ...
        `
            <div class="col-12">
                <div class="resena-contenido mb-3">
                    We still do not have reviews in English for this title.
                </div>                
            </div>
        `
    }
