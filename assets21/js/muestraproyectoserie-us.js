...
const url22 = "https://api.themoviedb.org/3/tv/" + valor + "?api_key=15c78749fb202cfe47bdd8f4989396e2";
      ...
      <div class="col-sm-12 col-md-7">
          <div class="row contenido p-3">
              <div class="col-sm-12 col-md-12 mb-3 titulo">
                  ${json.title ? json.title : json.name}
              </div>
              ...
              <div class="col-sm-12 col-md-12 col-lg-9 mb-2">
                  ${json.release_date ? json.release_date : json.first_air_date}
              </div>
              <div class="col-sm-12 col-md-12 col-lg-3 mb-2">
                  <strong>Producting:</strong>
              </div>
              <div class="col-sm-12 col-md-12 col-lg-9 mb-2">
              ...
              <div class="col-12 my-5">
                  <nav>
                      <div class="nav nav-tabs" id="nav-tab" role="tablist">
                          ...
                          <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Cast</button>
